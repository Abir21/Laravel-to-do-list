            ...
            <div class="offset-2 col-md-8 my-5">
                ...
                <form action="" method="post" class="form-inline">
                    ...
                    <div class="form-group mx-sm-3 mb-3">
                        ...
                        <input type="text" name="title" class="form-control" id="title" placeholder="what is your title?">
                    </div>
                    <div class="form-group mx-sm-3 mb-2">
                        <input type="submit" class="btn btn-outline-success mb-2" value="Create">
                    </div>
                </form>
